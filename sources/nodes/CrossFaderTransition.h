#ifndef __CrossFaderTransition_H__
#define __CrossFaderTransition_H__
...
{	
public:					// *** ctor/dtor
	virtual ~CrossFaderTransition();
	CrossFaderTransition(BMediaAddOn* pAddOn=0);

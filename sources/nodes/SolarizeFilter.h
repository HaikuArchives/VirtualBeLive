#ifndef __SOLARIZEFILTER_H__
#define __SOLARIZEFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~SolarizeFilter();
	SolarizeFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_THRESHOLD , P_MODE };
	int32					threshold,mode;
	bigtime_t				fLastSolarChange;

#ifndef __EMBOSSFILTER_H__
#define __EMBOSSFILTER_H__
...
public:					// *** ctor/dtor
	...
	EmbossFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_RANGE , P_INTENSITY , P_BIAS};
	int32					RANGE,INTENSITY,BIAS;
	bigtime_t				fLastEmbossChange;

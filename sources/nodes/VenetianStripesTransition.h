#ifndef __VenetianStripesTransition_H__
#define __VenetianStripesTransition_H__
...
class VenetianStripesTransition :
...
{	
public:					// *** ctor/dtor
	virtual ~VenetianStripesTransition();
	VenetianStripesTransition(BMediaAddOn* pAddOn=0);
...
public:					// *** BBufferConsumer
	...
	virtual status_t AcceptFormat(const media_destination& destination,	media_format* format);
...
//	virtual void initParameterWeb();
	...
	virtual void MakeTransition(BBuffer *inBuffer, BBuffer *inBuffer2); //nyi
...
private:					// *** connection/format members
	...
	media_input				first_input;
	media_input				second_input;
...
private:					// *** add-on stuff
	...
	bool			readytosend;
	bool			additionalbufferrequested;
	
	bool			firstInputBufferHere;
	bool			secondInputBufferHere;
	BBuffer			*firstBuffer;
	BBuffer			*secondBuffer;
	BBuffer			*transitionBuffer;

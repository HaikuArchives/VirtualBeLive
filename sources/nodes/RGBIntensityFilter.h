#ifndef __RGBINTENSITYFILTER_H__
#define __RGBINTENSITYFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~RGBIntensityFilter();
	RGBIntensityFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_RI, P_GI, P_BI, P_RR, P_GR, P_BR };
	int						RIntensity, GIntensity, BIntensity;
	uint32					RRand, GRand, BRand;
	bigtime_t				fLastRGBIntensityChange;

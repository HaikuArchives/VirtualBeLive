#ifndef __TRAMEFILTER_H__
#define __TRAMEFILTER_H__
...
public:					// *** ctor/dtor
	virtual ~TrameFilter();
	TrameFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_RED, P_GREEN, P_BLUE, P_THICKNESS };
	uint32					alphaR, alphaG, alphaB, THICKNESS;
	bigtime_t				fLastTrameChange;

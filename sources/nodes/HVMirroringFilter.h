#ifndef __HVMIRRORINGFILTER_H__
#define __HVMIRRORINGFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~HVMirroringFilter();
	HVMirroringFilter(BMediaAddOn* pAddOn=0);

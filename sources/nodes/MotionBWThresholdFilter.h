#ifndef __MOTIONBWTHRESHOLDFILTER_H__
#define __MOTIONBWTHRESHOLDFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~MotionBWThresholdFilter();
	MotionBWThresholdFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	int32					bwthreshold;
	uint32					*tmp_buffer;
	bigtime_t				fLastthresholdChange;

#ifndef __FRAMEBINOPFILTER_H__
#define __FRAMEBINOPFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~FrameBinOpFilter();
	FrameBinOpFilter(BMediaAddOn* pAddOn=0);

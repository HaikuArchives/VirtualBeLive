#ifndef __OFFSETFILTER_H__
#define __OFFSETFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~OffsetFilter();
	OffsetFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_DELTA_X , P_DELTA_Y };
	int32					DELTA_X,DELTA_Y;
	bigtime_t				fLastOffSetChange;

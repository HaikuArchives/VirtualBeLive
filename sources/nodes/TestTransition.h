#ifndef __TestTransition_H__
#define __TestTransition_H__
...
public:					// *** ctor/dtor
	...
	TestTransition(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	bool			fFirstInputConnected;
	bool			fSecondInputConnected;
	bool			fOutputConnected;

#ifndef __MOTIONRGBTHRESHOLDFILTER_H__
#define __MOTIONRGBTHRESHOLDFILTER_H__
...
class MotionRGBThresholdFilter :
...
{	
public:					// *** ctor/dtor
	virtual ~MotionRGBThresholdFilter();
	MotionRGBThresholdFilter(BMediaAddOn* pAddOn=0);
...
//	virtual void initParameterWeb();
	...
	virtual void filterBuffer(BBuffer* inBuffer); //nyi
...
private:					// *** add-on stuff
	...
	enum					{ P_RED, P_GREEN, P_BLUE};
	uint32					RThreshold, GThreshold, BThreshold;
	uint32					*tmp_buffer;
	bigtime_t				fLastRGBThresholdChange;

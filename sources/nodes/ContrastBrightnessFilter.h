#ifndef __CONTRASTBRIGHTNESSFILTER_H__
#define __CONTRASTBRIGHTNESSFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~ContrastBrightnessFilter();
	ContrastBrightnessFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_CFACTOR , P_BFACTOR };
	int32					CFACTOR,BFACTOR; 
	bigtime_t				fLastFactorChange;

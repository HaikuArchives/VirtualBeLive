#ifndef __DIFFDETECTIONFILTER_H__
#define __DIFFDETECTIONFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~DiffDetectionFilter();
	DiffDetectionFilter(BMediaAddOn* pAddOn=0);

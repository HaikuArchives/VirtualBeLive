#ifndef __STEPMOTIONBLURFILTER_H__
#define __STEPMOTIONBLURFILTER_H__
...
{	
public:					// *** ctor/dtor
	virtual ~StepMotionBlurFilter();
	StepMotionBlurFilter(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum					{ P_IMPACT , P_STEP };
	uint32					impact;
	uint64					count;
	uint32					step_period;
	uint32					*tmp_buffer;
	bigtime_t				fLastImpactChange;

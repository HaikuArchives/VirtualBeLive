#ifndef __FlipTransition_H__
#define __FlipTransition_H__
...
{	
public:					// *** ctor/dtor
	virtual ~FlipTransition();
	FlipTransition(BMediaAddOn* pAddOn=0);
...
private:					// *** add-on stuff
	...
	enum			{ P_STATE , P_MODE, P_X, P_Y, P_RED, P_GREEN, P_BLUE };
	uint32			TState;
	uint32			Mode;
